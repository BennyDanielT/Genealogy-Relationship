...
//
    Boolean recordDissolution( PersonIdentity partner1, PersonIdentity partner2 ) throws PersonNotFoundException,ClassNotFoundException,SQLException, DuplicateRecordException {
        Map<Integer,String> people = new HashMap<>();
        Connection con = null;
        Statement stmt = null;
        ResultSet resultSet = null;
